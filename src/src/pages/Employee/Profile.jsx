  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setFetchUser(data);
        console.log("data.profile.work_histories",data.skills)
...
//        selectedExperience.title ?? "dssdfsdfsdfsdfsdfsdfd"
//      );
//      setValue(
//        `experiences.${index}.jobDesc`,
//        selectedExperience.description ?? "dssdfsdfsdfsdfsdfsdfd"
//      );
//      setValue(
...
//      setTimeout(() => {
//console.log(
//  "lkbdlkvbskldbvlksbdkvbslkdbvlsdkvsdlkvsbdklv",
//  editIndex,
//  index,
//  //document.getElementById(`experienceForm_${index}`)
//);
    
//      document
//        .getElementById(`experienceForm_0`)
...
//  };
  ...
  const editExperience = (index) => {
    ...
    console.log(
      ...
      getValues(`experiences.${index}.jobTitle`),
      selectedExperience
    );

    if (selectedExperience) {
      setValue(`experiences.${index}.jobTitle`, selectedExperience.title ?? "iiiiiiii");
      setValue(
        `experiences.${index}.jobDesc`,
      ...
      // Set the index of the experience being edited
      setEditIndex(index);
console.log("errororororororor",errors)
      // Use requestAnimationFrame to ensure the DOM is ready
      requestAnimationFrame(() => {
        const element = document.getElementById(`experienceForm_${index}`);
        if (element) {
          element.scrollIntoView({ behavior: "smooth" });
        } else {
          console.error(`Element with ID experienceForm_${index} not found.`);
        }
      });
    }
  };
